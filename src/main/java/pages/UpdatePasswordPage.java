...
public class UpdatePasswordPage extends TestBase {
	...
	// -----------------------------------------------------------------------------------------------
	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@resource-id,'id/edit_current_password')]//following::android.widget.TextView[contains(@text,'Please enter a Password')][1]")
	...
	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@resource-id,'id/edit_new_password')]//following::android.widget.TextView[contains(@text,'Please enter a Password')][1]")
	...
	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@resource-id,'id/edit_new_password')]//following::android.widget.TextView[contains(@text,'Please enter a valid Password')][1]")
	...
	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@resource-id,'id/edit_current_password')]//following::android.widget.TextView[contains(@text,'Please enter a valid Password')][1]")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='Incorrect username or password.']")
