...
public class DiscoverPage extends TestBase {
	...
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name='Travel']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText[not(contains(@name,'by'))]")
	...
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name='Health']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText[not(contains(@name,'by'))]")
	...
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name='Wellness']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText[not(contains(@name,'by'))]")
	...
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name='Travel']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton[@name='Read More'][1]")
	...
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name='Health']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton[@name='Read More'][1]")
	...
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name='Wellness']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton[@name='Read More'][1]")
	private MobileElement btnWellnessReadMore1;

	@AndroidFindBy(xpath = "(//android.widget.TextView[@text='Travel']//following::android.widget.Button)[1]")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name='Read More'][1]")
	private MobileElement btnTrvlReadMoreInviewAll;

	@AndroidFindBy(xpath = "(//android.widget.TextView[@text='Health']//following::android.widget.Button)[1]")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name='Read More'][1]")
	private MobileElement btnHlthReadMoreInViewAll;

	@AndroidFindBy(xpath = "(//android.widget.TextView[@text='Wellness']//following::android.widget.Button)[1]")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name='Read More'][1]")
	...
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name='arrowLeft']//following-sibling::XCUIElementTypeButton[@name='share']")
	private MobileElement EleShareInReadMore;

	@AndroidFindBy(xpath = "(//android.widget.TextView[@text='Travel']//following::android.widget.ImageButton[contains(@resource-id,'id/image_button_share')])[1]")
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeButton[@name='share'])[2]")
	private MobileElement btnTrvlShareInviewAll;

	@AndroidFindBy(xpath = "(//android.widget.TextView[@text='Health']//following::android.widget.ImageButton[contains(@resource-id,'id/image_button_share')])[1]")
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeButton[@name='share'])[1]")
	private MobileElement btnHlthShareInviewAll;

	@AndroidFindBy(xpath = "(//android.widget.TextView[@text='Wellness']//following::android.widget.ImageButton[contains(@resource-id,'id/image_button_share')])[1]")
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeButton[@name='share'])[1]")
...
public MembershipPlansPage ClickOnKnowMoreInDiscover() {
	
	try {
		
		SwipeDownToViewKnowMoreButton();
		
		waitForElement(btnNonMemberKnowMore);
		
		if(isElementPresent(btnNonMemberKnowMore)) {
			
			clickOn(btnNonMemberKnowMore, "KnowMore button");
...
//-------------------------------------------iOS--------------------------------------------------------
				...
				if (isElementPresent(eleNonMemberContent)) {
					...
					List<WebElement> elemsBeforeSwipeContent = driver.findElementsByXPath(
							"(//XCUIElementTypeStaticText[@name='Travel']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText[not(contains(@name,'by'))]");

					List<WebElement> elemsBeforeSwipeAuthors = driver.findElementsByXPath(
							"(//XCUIElementTypeStaticText[@name='Travel']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText[contains(@name,'by')]");
					...
					for (int i = 1; i < contentLength1; i++) {
						lstUITrvlArticlecontentTitle
								.add((elemsAfterSwipeContent.get(i).getText().replaceAll("\\s+", "")));
					}

					for (int i = 1; i < authorLength1; i++) {

						lstUITrvlArticlecontentAuthor
								.add(elemsAfterSwipeAuthors.get(i).getText().replaceAll("\\s+", "").split("by")[1]);
					}

					System.out.println(lstUITrvlArticlecontentTitle);

					System.out.println(lstUITrvlArticlecontentAuthor);
	...
	public void ValidateLatestHealthArticleContentInDiscoverPage() {
		try {
			...
			if (GlobalKeys.configData.get("PlatFormName").equalsIgnoreCase("Android")) {
				...
				List<WebElement> elemsBeforeSwipeContent = driver.findElementsByXPath(
						"(//XCUIElementTypeStaticText[@name='Health']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText[not(contains(@name,'by'))]");

				List<WebElement> elemsBeforeSwipeAuthors = driver.findElementsByXPath(
						"(//XCUIElementTypeStaticText[@name='Health']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText[contains(@name,'by')]");
	...
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name='Health']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton[@name='share'][1]")
	...
	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeStaticText[@name='Wellness']//following-sibling::XCUIElementTypeScrollView)[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton[@name='share'][1]")
	private MobileElement btnWellnessShare;
	@AndroidFindBy(xpath = "//android.widget.ScrollView//following::android.widget.TextView[contains(@text,'Gmail')]//preceding::android.widget.ImageView[1]")
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeCell[@name='Mail']/XCUIElementTypeOther/XCUIElementTypeImage")
	private MobileElement btnMailApp;

	@AndroidFindBy(xpath = "//android.widget.TextView[@text='To']//following::android.widget.EditText[1]")
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@text='To']//following::android.widget.EditText[3]")
