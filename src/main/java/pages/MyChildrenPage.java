...
//			String StrMaxChar = generateRandomString(51);
//
//			waitForElement(txtFirstName);
//
//			txtFirstName.sendKeys(StrMaxChar);
//			
//
//			waitForElement(txtLastName);
//
//			txtLastName.sendKeys(StrMaxChar);
//			
//
//			waitForElement(btnUpdateDetails);
//
...
//
//			if (errFirstName.getText().trim().replaceAll("\\s+", "")
//					.equalsIgnoreCase(Constants.ErrInValidFirstName.trim().replaceAll("\\s+", ""))) {
//
//				passed("Successfully Validated FirstName Invalid Error Message in My Profile  As"
//						+ errFirstName.getText());
//			}
//
//			else {
//				failed(driver, "Failed To Validate FirstName Invalid Error Message in My Profile Expected  As"
//						+ Constants.ErrInValidFirstName + "But Actual is" + errFirstName.getText());
//			}
//
//			if (errLastName.getText().trim().replaceAll("\\s+", "")
//					.equalsIgnoreCase(Constants.ErrInValidLastName.trim().replaceAll("\\s+", ""))) {
//
//				passed("Successfully Validated LastName Invalid Error Message in My Profile  As"
//						+ errLastName.getText());
//			}
//
//			else {
//				failed(driver, "Failed To Validate  LastName Invalid Error Message in My Profile Expected  As"
//						+ Constants.ErrInValidLastName + "But Actual is" + errLastName.getText());
//			}
