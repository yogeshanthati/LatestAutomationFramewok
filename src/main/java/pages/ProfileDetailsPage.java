...
public class ProfileDetailsPage extends TestBase {
	...
	public void updateFieldsInProfileDetailsPage() {
		...
		try {
			...
			enterText(txtCity, "City In Create Profile", data.get("City"));
			...
			enterText(txtZIPCode, "ZIP Code In Create Profile", data.get("ZIPCode"));
...
public void EnterInValidNANPPhoneNumber() {
	...
	public void ValidateUpdatedProfileDetailsInAndroid() {
		...
		try {
			...
			if (UpdatedphoneNumber.equals(data.get("PhoneNumber"))) {
	...
	public void ValidateUpdateProfileDetailsInIOS() {
		...
		try {
			...
			if (UpdatedphoneNumber.equals("1" + data.get("PhoneNumber"))) {
