...
//	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@resource-id,'id/edit_address_1')]")
//	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='Address Line 1*']//preceding-sibling::XCUIElementTypeTextField[1]")
//	private MobileElement txtAddress1;
//
//	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@resource-id,'id/edit_address_2')]")
//	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='Address Line 2 (Optional)']//preceding-sibling::XCUIElementTypeTextField[1]")
//	private MobileElement txtAddress2;

//	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@resource-id,'id/edit_city')]")
//	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='City*']//preceding-sibling::XCUIElementTypeTextField[1]")
//	private MobileElement txtCity;
//
//	@AndroidFindBy(xpath = "//android.widget.Spinner[contains(@resource-id,'id/auto_complete_text_view')]")
//	@iOSXCUITFindBy(xpath = "(//XCUIElementTypeImage[@name='dropDown'])[2]")
...
//
//	@AndroidFindBy(xpath = "//android.widget.EditText[contains(@resource-id,'id/edit_zip')]")
//	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name='ZIP Code*']//preceding-sibling::XCUIElementTypeTextField[1]")
//	private MobileElement txtZIPCode;
	...
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name='person icon']")
	private MobileElement eleInAgreements;
	...
	@AndroidFindBy(xpath = " //android.widget.Spinner[contains(@resource-id,'id/auto_complete_text_view')]//following::android.widget.ImageButton[contains(@resource-id,'id/text_input_end_icon')]	")
	...
	public void validateNavigationToMandatoryAgreementCheckboxLinks() {
		...
		try {
			...
			waitForElement(eleInAgreements);

			waitForElement(eleInAgreements);

			if (isElementPresent(eleInAgreements)) {
