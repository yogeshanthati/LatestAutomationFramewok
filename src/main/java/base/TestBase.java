...
//update
	...
	public String generaterandomNANPnumber(String Number) {
		...
		String nanphNum = "";
		try {
			nanphNum = String.valueOf(Long.parseLong(Number.trim()) + Integer.parseInt(generateRandomNumber(1))
					+ Integer.parseInt(generateRandomNumber(1)) + Integer.parseInt(generateRandomNumber(2)));
		} catch (Exception e) {
